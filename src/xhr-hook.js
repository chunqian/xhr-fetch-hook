...
export function hook(proxy, realWindow = window) {
    // Avoid double hookAjax
    realWindow[realXhr] = realWindow[realXhr] || realWindow.XMLHttpRequest

    realWindow.XMLHttpRequest = function () {
        var xhr = new realWindow[realXhr];
    ...
    return realWindow[realXhr];
}

export function unHook(realWindow = window) {
    if (realWindow[realXhr]) realWindow.XMLHttpRequest = realWindow[realXhr];
    realWindow[realXhr] = undefined;
}
